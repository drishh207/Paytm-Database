...
CREATE TABLE `fixed_deposit` (
  ...
  `currr_date` date DEFAULT NULL,
  `curr_time` varchar(10) DEFAULT NULL,
...
INSERT INTO `fixed_deposit` VALUES (7854123659845,1469387412,120000,'2020-11-30','11:23','2021-11-30','11:23');
